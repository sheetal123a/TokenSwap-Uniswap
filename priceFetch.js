...
const provider = new ethers.providers.JsonRpcProvider(
    "https://eth-mainnet.g.alchemy.com/v2/tTLAAweBXKNjFRJu7kMCrrv774RrtG6F"  // blockchain read karne wale to provider chahiye blockchian ka rpc  search on google rpc binance node
)
...
const priceFetch=async(humanFormat)=>{
  ...
  const amountIn = ethers.utils.parseUnits(humanFormat,decimal1).toString();   // wei mein convert kar liya
  ...
  console.log("This the number of DAI: ",humanOutput)
}
humanFormat="1"
